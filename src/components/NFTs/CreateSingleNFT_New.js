...
import "./CreateSingleNFT_New.css";
...
function Favorite() {
      ...
      nftFile.saveIPFS().then((res0) => {
        ...
        if (res) {
          ...
          const metadata = {
            ...
            amount: values.MaximumSupply.toString(),
            nft: nftFilePath,
            filetype: filetype,
          ...
          nftFileMetadataFile.saveIPFS().then((res4) => {
            ...
            if (currency === "ETH") {
              hash = {
                ...
                maxAmount: values.MaximumSupply.toString(),
            ...
            const receipt = tokenContract.methods
              ...
              .then((res11) => {
                ...
                gameScore.set("amount", values.MaximumSupply.toString());
  ...
  const [Price_button, setPrice_button] = useState(false);
  const [Price_button2, setPrice_button2] = useState(false);
  const [currency_button, setcurrency_button] = useState(false);
  const [currency_button2, setcurrency_button2] = useState(false);
              ...
              >
                {isMinting ? (
                  ...
                  <form onSubmit={formik.handleSubmit}>
                    <div className="d-flex justify0-content-between col_split1">
                      <div className=" Col_left col1" style={{ width: "25%" }}>
                        <Heading3 className="mb-3">Your NFT File</Heading3>
                        <Heading4 className="mb-3 titleText">
                          Choose & upload your NFT file, which can be an image,
                          video, audio or #D model
                        </Heading4>
                        <Heading4 className="mb-3 subtitleText">
                    ...
                    <div className="d-flex justify-content-between col_split1">
                      <div className="Col_left col1">
                        <Heading3 className="mb-1">Name/Title</Heading3>
                        <Heading4 className="mb-3 titleText">
                          Chose a name for your NFT{" "}
                        </Heading4>
                      </div>

                      <div className="Col_right col1">
                        <div className="mb-1" style={{ maxWidth: "98%" }}>
                          <CssTextField
                            id="Name"
                            multiline
                    ...
                    <div className="d-flex justify-content-between col_split1">
                      <div className="Col_left col1">
                        ...
                        <Heading4 className="mb-3 titleText">
                          The description will be included on the item's details
                          page
                        </Heading4>
                      </div>
                    ...
                    <div className="d-flex justify-content-between col_split2">
                      <div className="Col_left col2">
                        <Heading3 className="mb-1">Selling Style</Heading3>
                        <Heading4 className="mb-3 titleText">
                          You can sell your NFT for a fixed price or have users
                          bid on your NFT
                        </Heading4>
                      </div>

                      <div className="Col_right col2">
                        <div className="d-flex">
                          <div
                            onClick={(e) => {
                              setPrice_button(true);
                              setPrice_button2(false);
                            }}
                            className={`${
                              Price_button
                                ? "squareButton_pressed"
                                : "squareButton"
                            }`}
                          >
                            <FontAwesomeIcon
                          ...
                          <div
                            onClick={(e) => {
                              setPrice_button2(true);
                              setPrice_button(false);
                            }}
                            className={`${
                              Price_button2
                                ? "squareButton_pressed"
                    ...
                    <div className="d-flex justify-content-between col_split2">
                      <div className="Col_left col2">
                        <Heading3 className="mb-1">Currency</Heading3>
                        <Heading4 className="mb-3 titleText">
                          You can sell your NFT in either ETH or PIKA tokens
                        </Heading4>
                      </div>
                      ...
                      <div className="Col_right col2">
                        <div className="d-flex">
                          <div
                            onClick={(e) => {
                              setcurrency_button(true);
                              setcurrency_button2(false);
                              handleClosemenu2();
                            }}
                            className={`${
                              currency_button
                          ...
                          >
                            <Image
                              ...
                              style={{ marginBottom: "5px" }}
                            />
                            <Heading4 className="mb-3 titleText">ETH</Heading4>
                          </div>

                          <div
                            onClick={(e) => {
                              setcurrency_button2(true);
                              setcurrency_button(false);
                              handleClosemenu3();
                            }}
                            className={`${
                              currency_button2
                          ...
                          >
                            <Image
                              ...
                              style={{ marginBottom: "5px" }}
                            />
                            <Heading4 className="mb-3 titleText">PIKA</Heading4>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between col_split2">
                      <div className="Col_left col2">
                        <Heading3 className="mb-1">Seling Price</Heading3>
                        <Heading4 className="mb-3 titleText">
                          How much do you want to list your item for{" "}
                        </Heading4>
                        <Heading4 className="mb-3 subtitleText">
                          You can list yor item in ETH/PIKA. Be sure to specify
                          the correct amount depending on your selected currency
                        </Heading4>
                      </div>
                          ...
                          <div>
                            <div className="d-flex flex-wrap">
                              <div
                                ...
                                style={{ marginInline: "60px", width: "160px" }}
                              >
                            ...
                            <div className="d-flex justify-content-between  col_split1">
                              <div className="Col_left  col1">
                                ...
                                <Heading4 className="mb-3 titleText">
                                  Select the Maximum supply where you’d like new
                            ...
                            <div className="d-flex justify-content-between  col_split1">
                              <div className="Col_left  col1">
                                ...
                                <Heading4 className="mb-3 titleText">
                                  Add properties to make your NFT standout
                                </Heading4>
                              </div>
                              ...
                              <div className="Col_right  col1">
                                <DialogContent id="trade">
                                  {inputList.map((x, i) => {
                                    return (
                                      <div
                                        className="d-flex justify-content_center  flex-wrap"
                                        style={{ float: "left" }}
                                      >
                            ...
                            <div className="d-flex justify-content-between  col_split1">
                              <div className="Col_left  col1">
                                ...
                                <Heading4 className="mb-3 titleText">
                                  NFT royalties give you a percentage of the
                                  sale price each time your NFT is solid
                                </Heading4>
                                <Heading4 className="mb-3 subtitleText">
                                  Allowed 1 to 10
                                </Heading4>
                            ...
                            <div className="d-flex justify-content-between  col_split1">
                              <div className="Col_left  col1">
                                ...
                                <Heading4 className="mb-3 titleText"></Heading4>
                              </div>
