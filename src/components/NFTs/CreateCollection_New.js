                        ...
                        {isCreatingCollection ? (
                            ...
                            <>
                                <div className='d-flex justify0-content-between col_split1'>
                                    <div className=' Col_left col1' style={{ width: "35%" }}>
                                        <Heading3 className="mb-3">Your NFT File</Heading3>
                                        <Heading4 className="mb-3 titleText">
                                            Choose & upload your NFT file, which can be an image, video, audio or #D model
                                        </Heading4>
                                    </div>

                                    <div className='w-100  col1'>
                                        <div
                                            className="mb-3"
                                            style={{
                                ...
                                <div className='w-100 d-flex justify-content-between  col_split1 '>
                                    <div className='Col_left  col1 '>
                                        <Heading3 className="mb-3">Name/Title</Heading3>
                                        <Heading4 className="mb-3 titleText" >
                                ...
                                <div className='d-flex justify-content-between  col_split1'>
                                    ...
                                    <div className='Col_right  col1'>
                                        <DialogContent id="trade">
                                            {inputList.map((x, i) => {
                                                return (
                                                    <div className="d-flex justify-content_center flex-wrap" style={{ float: "left" }}>
