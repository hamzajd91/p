...
function EditNFT() {
  ...
  const [carddescription, setcarddescription] = useState(
    location.state.Nftdetails
  );
  console.log("260", carddescription);
  ...
  const [properties1, setproperties1] = useState([1, 2, 3]);
  const [checkVisibility, setcheckVisibility] = useState("none");
  useEffect(() => {
    setUploadImage(carddescription.nft);
  ...
  async function data111() {
    ...
    if (res[0] !== undefined) {
      query.equalTo("address", res[0].toLowerCase());
    ...
    web3.eth.getAccounts().then(async (res) => {
      ...
      query2.equalTo("address", res[0].toLowerCase());
        ...
        web3.eth.getAccounts().then((res) => {
          ...
          nftFileMetadataFile.saveIPFS().then((res4) => {
            ...
            var hash = {
              ...
              seller: res[0].toLowerCase(),
              beneficiary: res[0].toLowerCase(),
              maxAmount: "1",
              ...
              royalty: "0",
              royaltyReceiver: res[0].toLowerCase(),
              totalSupply: "1",
            };
            ...
            const receipt = tokenContract.methods
              .create(count1.toString(), 1, res[0].toLowerCase(), 0, [])
              .send({
                from: res[0].toLowerCase(),
              })
              ...
              .then((res11) => {
                ...
                gameScore.set("address", res[0].toLowerCase());
  ...
  const [MenuHead, setMenuHead] = useState("Select Currency");
  ...
  const validationSchema = yup.object({
    ...
    Amount: yup
      ...
      //   "Amount should be less than Maximum Supply"
      // )
              ...
              >
                {isMinting ? (
                  ...
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    <div>
                      <Heading3 className="mb-3">Royality</Heading3>{" "}
                      <CssTextField
                        id="Royality"
                        multiline
                    ...
                    <div className="">
                      <Heading3 className="mb-3">Currency</Heading3>{" "}
                      <div className=" d-flex align-items-center">
                        <input
                          type="number"
                          placeholder="Enter Amount"
                          disabled={currencyToggle}
                          style={{
                            border: "none",
                            borderRadius: "5px",
                            color: "grey",
                      ...
                      <div className=" d-flex align-items-center">
                        <input
                          type="number"
                          disabled="true"
                          value={CurrencyConvert * currencyMultiplier}
                          style={{
                            border: "none",
                            borderRadius: "5px",
                            color: "grey",
                      ...
                      <div className=" d-flex align-items-center mt-3">
                        ...
                        >
                          {" "}
                          {(CurrencyConvert / 100) * 20} <span>US $</span>{" "}
                        </Heading3>
                      </div>
                      <Button
                        style={{
